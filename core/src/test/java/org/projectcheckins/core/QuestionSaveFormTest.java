...
class QuestionSaveFormTest {
    ...
    void daysReturnsNotNull() {
        assertThat(new QuestionSaveForm(null, HowOften.DAILY_ON, null, null, null, null, null, null, null, null, null))
                .extracting(QuestionSaveForm::days)
                .isNotNull();
        assertThat(new QuestionSaveForm(null, HowOften.ONCE_A_WEEK, null, null, null, null, null, null, null, null, null))
                .extracting(QuestionSaveForm::days)
                .isNotNull();
        assertThat(new QuestionSaveForm(null, HowOften.EVERY_OTHER_WEEK, null, null, null, null, null, null, null, null, null))
                .extracting(QuestionSaveForm::days)
                .isNotNull();
        assertThat(new QuestionSaveForm(null, HowOften.ONCE_A_MONTH_ON_THE_FIRST, null, null, null, null, null, null, null, null, null))
                .extracting(QuestionSaveForm::days)
                .isNotNull();
    }
